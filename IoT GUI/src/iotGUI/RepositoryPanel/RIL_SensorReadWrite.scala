...
class RIL_SensorReadWrite(inText: String, inBorderWeight: Int = 1) extends RepositoryItemLabel(inText, inBorderWeight) {
  ...
  def setAll(uid: Long, 
	...
	{
		var newRIL = new RIL_SensorReadWrite(text, borderWeight)
